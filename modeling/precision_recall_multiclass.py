...
def precision_recall_multiclass(y_pred,y_val,target_list):
    ...
    print("-------#####-------")
    print("\n")
    print("-----Macro/Micro Recall and Precisions-----")
    print("Macro recall:",recall_score(y_val,y_pred_absolutes, average="macro"),"Micro recall:",recall_score(y_val,y_pred_absolutes, average="micro"))
    print("Macro precision:",precision_score(y_val,y_pred_absolutes, average="macro"),"Micro precision:",precision_score(y_val,y_pred_absolutes, average="micro"))
    print("------------#####------------")